...
export default function App() {
  ...
  const handleGenerate2D = async () => {
    ...
    try {
      ...
      setError('Failed to generate 2D graph');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="app">
      ...
      {show2D && <div ref={graph2DRef}><Graph2DSection input={functionInput} /></div>}
      {show3D && <div ref={graph3DRef}><Graph3DSection input={functionInput} /></div>}
    </div>
  );
}